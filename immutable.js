...
const superVillains = ["Joker", "Lex Luther", "Venom", "Ironman Villain"];
...
const studentScores = {
  name: "Tyson",
  age: 31,
  scores: [1, 25, 36, 47, 50],
}

const studentAverage = Object.assign({}, studentScores.scores.filter(score => score < 34));
